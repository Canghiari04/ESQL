...
\begin{itemize}[label={-}]
    \itemsep1px
    \item {\small\bf{OPERAZIONE 1.}} Inserire un nuovo studente
    \item {\small\bf{OPERAZIONE 2.}} Inserire un nuovo docente
    \item {\small\bf{OPERAZIONE 3.}} Visualizzare i dati degli studenti che abbiano svolto i test somministrati dal docente
    \item {\small\bf{OPERAZIONE 4.}} Inserire una nuova tabella di esercizio, con i propri meta-dati 
    \item {\small\bf{OPERAZIONE 5.}} 
\end{itemize}
