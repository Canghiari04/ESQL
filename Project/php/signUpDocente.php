        ...
        <div class="center">
            <form action="authentication.php" method="POST">
                <div style="margin-top: 30px;">
                    ...
                    <input class="input" type="text" id="txtEmailSignupDocente" name="txtEmailSignupDocente">
                </div>
                <div style="margin-top: 8px;">
                    <label>Password</label>
                    <input class="input" type="password" id="txtPasswordSignupDocente" name="txtPasswordSignupDocente">
                </div>
                <div style="margin-top: 8px;">
                    <label class="label-inline">Nome</label>
                    <input class="input" type="text" id="txtNomeSignupDocente" name="txtNomeSignupDocente">
                </div>
                <div style="margin-top: 8px;">
                    <label>Cognome</label>
                    <input class="input" type="text" id="txtCognomeSignupDocente" name="txtCognomeSignupDocente">
                </div>
                <div style="margin-top: 8px;">
