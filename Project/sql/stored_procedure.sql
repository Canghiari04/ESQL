...
DELIMITER |
CREATE PROCEDURE Inserimento_Opzione_Risposta(IN ID_DOMANDA_CHIUSA INT, IN TESTO VARCHAR(255)) 
BEGIN
	INSERT INTO Opzione_Risposta(ID, ID_DOMANDA_CHIUSA, TESTO) VALUES (NULL, ID_DOMANDA_CHIUSA, TESTO);
END ;
| 
DELIMITER ;

DELIMITER |
CREATE PROCEDURE Inserimento_Sketch_Codice(IN ID_DOMANDA_CODICE INT, IN TESTO VARCHAR(255)) 
BEGIN
	INSERT INTO Sketch_Codice(ID, ID_DOMANDA_CODICE, TESTO) VALUES (NULL, ID_DOMANDA_CODICE, TESTO);
END ;
| 
DELIMITER ;
