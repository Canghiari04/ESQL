...
DELIMITER |
CREATE PROCEDURE Inserimento_Quesito(IN DIFFICOLTA ENUM('BASSO', 'MEDIO', 'ALTO'), IN NUM_RISPOSTE INT, IN DESCRIZIONE VARCHAR(255))
BEGIN
	INSERT INTO Quesito(ID, DIFFICOLTA, NUM_RISPOSTE, DESCRIZIONE) VALUES (NULL, DIFFICOLTA, NUM_RISPOSTE, DESCRIZIONE);
END ;
| 
DELIMITER ;
...
DELIMITER |
CREATE PROCEDURE Inserimento_Opzione_Risposta(IN ID_DOMANDA_CHIUSA INT, IN TESTO VARCHAR(255), IN SOLUZIONE BOOLEAN) 
BEGIN
	INSERT INTO Opzione_Risposta(ID, ID_DOMANDA_CHIUSA, TESTO, SOLUZIONE) VALUES (NULL, ID_DOMANDA_CHIUSA, TESTO, SOLUZIONE);
END ;
| 
DELIMITER ;

DELIMITER |
CREATE PROCEDURE Inserimento_Sketch_Codice(IN ID_DOMANDA_CODICE INT, IN TESTO VARCHAR(255), IN SOLUZIONE BOOLEAN) 
BEGIN
	INSERT INTO Sketch_Codice(ID, ID_DOMANDA_CODICE, TESTO, SOLUZIONE) VALUES (NULL, ID_DOMANDA_CODICE, TESTO, SOLUZIONE);
END ;
| 
DELIMITER ;

DELIMITER |
CREATE PROCEDURE Inserimento_Afferenza(IN ID_QUESITO INT, IN ID_TABELLA INT) 
BEGIN
	INSERT INTO Afferenza(ID_QUESITO, ID_TABELLA) VALUES (ID_QUESITO, ID_TABELLA);
END ;
| 
DELIMITER ;
...
DELIMITER |
CREATE PROCEDURE Inserimento_Composizione(IN TITOLO_TEST VARCHAR(255), IN ID_QUESITO INT) 
BEGIN
	INSERT INTO Composizione(TITOLO_TEST, ID_QUESITO) VALUES (TITOLO_TEST, ID_QUESITO); 
END ;
| 
DELIMITER ;
...
DELIMITER |
CREATE PROCEDURE Eliminazione_Composizione(IN TITOLO_TEST VARCHAR(255), IN ID_QUESITO INT)
BEGIN
	DECLARE countComposition INT DEFAULT 0;
