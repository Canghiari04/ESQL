...
BEGIN
	...
	ELSE 
		UPDATE Risposta SET Risposta.TESTO=TESTO AND Risposta.ESITO=ESITO WHERE (Risposta.EMAIL_STUDENTE=EMAIL_STUDENTE) AND (Risposta.ID_QUESITO=ID_QUESITO) AND (Risposta.TITOLO_TEST=TITOLO_TEST);
	END IF;
END ;
| 
DELIMITER ;
