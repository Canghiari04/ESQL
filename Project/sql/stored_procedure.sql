...
DELIMITER |
CREATE PROCEDURE Aggiunta_Tabella_Esercizio(IN NOME VARCHAR(255), IN DATA_CREAZIONE DATETIME, IN NUM_RIGHE INT)
BEGIN
	DECLARE countTabella INT DEFAULT 0;
...
DELIMITER |
CREATE PROCEDURE Aggiunta_Attributo(IN ID_TABELLA INT, IN TIPO VARCHAR(255), IN NOME VARCHAR(255), IN CHIAVE_PRIMARIA BOOLEAN) 
BEGIN
...
DELIMITER |
CREATE PROCEDURE Aggiunta_Test(IN TITOLO VARCHAR(255), IN EMAIL_DOCENTE VARCHAR(255), IN FOTO BLOB, IN DATA_CREAZIONE DATE, IN VISUALIZZA_RISPOSTE BOOLEAN) 
BEGIN
...
DELIMITER |
CREATE PROCEDURE Aggiunta_Quesito(IN TITOLO_TEST VARCHAR(255), IN DIFFICOLTA ENUM, IN DESCRIZIONE VARCHAR(255), NUM_RISPOSTE INT) 
BEGIN
