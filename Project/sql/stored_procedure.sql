...
DELIMITER |
CREATE PROCEDURE Inserimento_Risposta(IN EMAIL_STUDENTE VARCHAR(255), IN ID_QUESITO INT, IN TESTO VARCHAR(255), IN ESITO BOOLEAN) 
BEGIN
	INSERT INTO Risposta(EMAIL_STUDENTE, ID_QUESITO, TESTO, ESITO) VALUES (EMAIL_STUDENTE, ID_QUESITO, TESTO, ESITO);
END ;
| 
DELIMITER ;
