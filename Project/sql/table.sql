...
CREATE TABLE Attributo (
    ...
    FOREIGN KEY (ID_TABELLA_ESERCIZIO) REFERENCES Tabella_Esercizio(ID_TABELLA)
)ENGINE=INNODB ;
...
CREATE TABLE Vincolo_Integrita (
    ...
    FOREIGN KEY (REFERENTE) REFERENCES Attributo(ID_ATTRIBUTO) ON DELETE CASCADE,
    FOREIGN KEY (REFERENZA) REFERENCES Attributo(ID_ATTRIBUTO) ON DELETE CASCADE
)ENGINE=INNODB ;
