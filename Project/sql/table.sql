...
CREATE TABLE Attributo (
    ...
    FOREIGN KEY(ID_ATTRIBUTO) REFERENCES Tabella_Esercizio(ID) ON DELETE CASCADE 
)ENGINE=INNODB ;
...
CREATE TABLE Domanda_Chiusa (
    ...
    FOREIGN KEY(ID_DOMANDA_CHIUSA) REFERENCES Quesito(ID)    
)ENGINE=INNODB ;
...
CREATE TABLE Domanda_Codice (
    ...
    FOREIGN KEY(ID_DOMANDA_CODICE) REFERENCES Quesito(ID)    
)ENGINE=INNODB ;
